...
namespace mlaskal {
	...
	abstract_instr(ai::IC_OPCODE opc, ICREGNUM out, aic_literal_storage_int_type::const_iterator litint, ICREGNUM in1, ICREGNUM in2, ICREGNUM in3, ICREGNUM in4) 
					    : opc_(opc), in1_(in1), in2_(in2), in3_(in3), in4_(in4), out_(out), litint_(litint), uid_(uid_all.get_UID()) { }
	abstract_instr(ai::IC_OPCODE opc, ICREGNUM out, aic_literal_storage_real_type::const_iterator litreal, ICREGNUM in1, ICREGNUM in2, ICREGNUM in3, ICREGNUM in4) 
					    : opc_(opc), in1_(in1), in2_(in2), in3_(in3), in4_(in4), out_(out), litreal_(litreal), uid_(uid_all.get_UID()) { }
	abstract_instr(ai::IC_OPCODE opc, ICREGNUM out, aic_literal_storage_string_type::const_iterator litstr, ICREGNUM in1, ICREGNUM in2, ICREGNUM in3, ICREGNUM in4) 
	...
	aic_literal_storage_int_type::const_iterator get_litint() const { return litint_; }
	/// real literal parameter
	aic_literal_storage_real_type::const_iterator get_litreal() const { return litreal_; }
	/// string literal parameter
	aic_literal_storage_string_type::const_iterator get_litstr() const { return litstr_; }
	...
	**/
	...
	void patch_litint(aic_literal_storage_int_type::const_iterator litint) { patch_litint_int_(litint); }
	/// set real literal parameter
	void patch_litreal(aic_literal_storage_real_type::const_iterator litreal) { patch_litreal_int_(litreal); }
	/// set string literal parameter
	void patch_litstr(aic_literal_storage_string_type::const_iterator litstr) { patch_litstr_int_(litstr); }
	...
	**/
	...
	aic_literal_storage_int_type::const_iterator		    litint_;
	aic_literal_storage_real_type::const_iterator		    litreal_;
	aic_literal_storage_string_type::const_iterator		    litstr_;
	ICRELNUM						    stkoffs_;
	ICABSNUM						    absnum_;
	...
	virtual void patch_litint_int_(aic_literal_storage_int_type::const_iterator litint)=0;
	virtual void patch_litreal_int_(aic_literal_storage_real_type::const_iterator litreal)=0;
	virtual void patch_litstr_int_(aic_literal_storage_string_type::const_iterator litstr)=0;
