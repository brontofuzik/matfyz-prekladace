		...
		<xsl:for-each select="/icminstr/instrs/instr">
			...
			<xsl:choose>
				<xsl:when test="./operand='LITINT'">
					<xsl:text>mlaskal::aic_literal_storage_int_type::const_iterator litint</xsl:text>
				</xsl:when>
				<xsl:when test="./operand='LITREAL'">
					<xsl:text>mlaskal::aic_literal_storage_real_type::const_iterator litreal</xsl:text>
				</xsl:when>
				<xsl:when test="./operand='LITSTR'">
					<xsl:text>mlaskal::aic_literal_storage_string_type::const_iterator litstr</xsl:text>
				</xsl:when>
			...
			<xsl:call-template name="TAB"/>
			<xsl:call-template name="TAB"/>
			<xsl:text>virtual void patch_litint_int_(mlaskal::aic_literal_storage_int_type::const_iterator</xsl:text>
			<xsl:choose>
				<xsl:when test="./operand='LITINT'">
			...
			<xsl:call-template name="TAB"/>
			<xsl:call-template name="TAB"/>
			<xsl:text>virtual void patch_litreal_int_(mlaskal::aic_literal_storage_real_type::const_iterator</xsl:text>
			<xsl:choose>
				<xsl:when test="./operand='LITREAL'">
			...
			<xsl:call-template name="TAB"/>
			<xsl:call-template name="TAB"/>
			<xsl:text>virtual void patch_litstr_int_(mlaskal::aic_literal_storage_string_type::const_iterator</xsl:text>
			<xsl:choose>
				<xsl:when test="./operand='LITSTR'">
