...
namespace ai {
	...
	private:
		...
		virtual void patch_litint_int_(mlaskal::aic_literal_storage_int_type::const_iterator) { throw std::logic_error("Instruction has no LITINT"); }
		virtual void patch_litreal_int_(mlaskal::aic_literal_storage_real_type::const_iterator) { throw std::logic_error("Instruction has no LITREAL"); }
		virtual void patch_litstr_int_(mlaskal::aic_literal_storage_string_type::const_iterator) { throw std::logic_error("Instruction has no LITSTR"); }
	...
	public:
		ELDLITI(mlaskal::ICREGNUM out, mlaskal::aic_literal_storage_int_type::const_iterator litint) : mlaskal::abstract_instr(ai::ICOP_ELDLITI, out, litint, 0, 0, 0, 0) { }
	...
	private:
		...
		virtual void patch_in4_int_(mlaskal::ICREGNUM) { throw std::logic_error("Instruction has no IN4"); }
		virtual void patch_out_int_(mlaskal::ICREGNUM reg) { out_=reg; }
		virtual void patch_litint_int_(mlaskal::aic_literal_storage_int_type::const_iterator litint) { litint_=litint; }
		virtual void patch_litreal_int_(mlaskal::aic_literal_storage_real_type::const_iterator) { throw std::logic_error("Instruction has no LITREAL"); }
		virtual void patch_litstr_int_(mlaskal::aic_literal_storage_string_type::const_iterator) { throw std::logic_error("Instruction has no LITSTR"); }
		virtual void patch_absnum_int_(mlaskal::ICABSNUM) { throw std::logic_error("Instruction has no ABSNUM"); }
		virtual void patch_stkoffs_int_(mlaskal::ICRELNUM) { throw std::logic_error("Instruction has no STKOFFS"); }
	...
	public:
		ELDLITR(mlaskal::ICREGNUM out, mlaskal::aic_literal_storage_real_type::const_iterator litreal) : mlaskal::abstract_instr(ai::ICOP_ELDLITR, out, litreal, 0, 0, 0, 0) { }
	...
	private:
		...
		virtual void patch_out_int_(mlaskal::ICREGNUM reg) { out_=reg; }
		virtual void patch_litint_int_(mlaskal::aic_literal_storage_int_type::const_iterator) { throw std::logic_error("Instruction has no LITINT"); }
		virtual void patch_litreal_int_(mlaskal::aic_literal_storage_real_type::const_iterator litreal) { litreal_=litreal; }
		virtual void patch_litstr_int_(mlaskal::aic_literal_storage_string_type::const_iterator) { throw std::logic_error("Instruction has no LITSTR"); }
		virtual void patch_absnum_int_(mlaskal::ICABSNUM) { throw std::logic_error("Instruction has no ABSNUM"); }
		virtual void patch_stkoffs_int_(mlaskal::ICRELNUM) { throw std::logic_error("Instruction has no STKOFFS"); }
		virtual void patch_reljump_int_(mlaskal::plain_icblock<mlaskal::abstract_instr>::const_iterator) { throw std::logic_error("Instruction has no RELJUMP"); }
	...
	public:
		ELDLITS(mlaskal::ICREGNUM out, mlaskal::aic_literal_storage_string_type::const_iterator litstr) : mlaskal::abstract_instr(ai::ICOP_ELDLITS, out, litstr, 0, 0, 0, 0) { }
	...
	private:
		...
		virtual void patch_litint_int_(mlaskal::aic_literal_storage_int_type::const_iterator) { throw std::logic_error("Instruction has no LITINT"); }
		virtual void patch_litreal_int_(mlaskal::aic_literal_storage_real_type::const_iterator) { throw std::logic_error("Instruction has no LITREAL"); }
		virtual void patch_litstr_int_(mlaskal::aic_literal_storage_string_type::const_iterator litstr) { litstr_=litstr; }
		virtual void patch_absnum_int_(mlaskal::ICABSNUM) { throw std::logic_error("Instruction has no ABSNUM"); }
		virtual void patch_stkoffs_int_(mlaskal::ICRELNUM) { throw std::logic_error("Instruction has no STKOFFS"); }
		virtual void patch_reljump_int_(mlaskal::plain_icblock<mlaskal::abstract_instr>::const_iterator) { throw std::logic_error("Instruction has no RELJUMP"); }
		virtual void patch_absjump_int_(mlaskal::abstract_functions::const_iterator) { throw std::logic_error("Instruction has no ABSJUMP"); }
	...
	public:
		LDLITI(mlaskal::aic_literal_storage_int_type::const_iterator litint) : mlaskal::abstract_instr(ai::ICOP_LDLITI, 0, litint, 0, 0, 0, 0) { }
	...
	public:
		LDLITR(mlaskal::aic_literal_storage_real_type::const_iterator litreal) : mlaskal::abstract_instr(ai::ICOP_LDLITR, 0, litreal, 0, 0, 0, 0) { }
	...
	public:
		LDLITS(mlaskal::aic_literal_storage_string_type::const_iterator litstr) : mlaskal::abstract_instr(ai::ICOP_LDLITS, 0, litstr, 0, 0, 0, 0) { }
